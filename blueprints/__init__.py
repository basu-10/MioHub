...
bps=[core_blueprint, p1_blueprint, p2_blueprint, notes_bp, whiteboard_bp, folder_bp, combined_bp, file_bp, infinite_whiteboard_bp, graph_bp, p3_blueprint, p4_blueprint, auth_blueprint, health_bp]    
